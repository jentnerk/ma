...
module shift_serializer_00000020_00000005_00000010 ( data_i, data_o, clk, 
  ...
  DFFRPQ_X0P5M_A9TS Counter_SP_reg_0_ ( .D(ready_o), .CK(clk), .R(reset), .Q(
        Counter_SP_0_) );
  INV_X1M_A9TS U3 ( .A(Counter_SP_0_), .Y(ready_o) );
  AO22_X0P7M_A9TS U4 ( .A0(Counter_SP_0_), .A1(Reg_SP_30_), .B0(ready_o), .B1(
        data_i[31]), .Y(Reg_SN[31]) );
  AO22_X0P7M_A9TS U5 ( .A0(Counter_SP_0_), .A1(data_o[14]), .B0(ready_o), .B1(
        data_i[15]), .Y(Reg_SN[30]) );
  AO22_X0P7M_A9TS U6 ( .A0(Counter_SP_0_), .A1(Reg_SP_28), .B0(ready_o), .B1(
        data_i[30]), .Y(Reg_SN[29]) );
  AO22_X0P7M_A9TS U7 ( .A0(Counter_SP_0_), .A1(data_o[13]), .B0(ready_o), .B1(
        data_i[14]), .Y(Reg_SN[28]) );
  AO22_X0P7M_A9TS U8 ( .A0(Counter_SP_0_), .A1(Reg_SP_26), .B0(ready_o), .B1(
        data_i[29]), .Y(Reg_SN[27]) );
  AO22_X0P7M_A9TS U9 ( .A0(Counter_SP_0_), .A1(data_o[12]), .B0(ready_o), .B1(
        data_i[13]), .Y(Reg_SN[26]) );
  AO22_X0P7M_A9TS U10 ( .A0(Counter_SP_0_), .A1(Reg_SP_24), .B0(ready_o), .B1(
        data_i[28]), .Y(Reg_SN[25]) );
  AO22_X0P7M_A9TS U11 ( .A0(Counter_SP_0_), .A1(data_o[11]), .B0(ready_o), 
        .B1(data_i[12]), .Y(Reg_SN[24]) );
  AO22_X0P7M_A9TS U12 ( .A0(Counter_SP_0_), .A1(Reg_SP_22), .B0(ready_o), .B1(
        data_i[27]), .Y(Reg_SN[23]) );
  AO22_X0P7M_A9TS U13 ( .A0(Counter_SP_0_), .A1(data_o[10]), .B0(ready_o), 
        .B1(data_i[11]), .Y(Reg_SN[22]) );
  AO22_X0P7M_A9TS U14 ( .A0(Counter_SP_0_), .A1(Reg_SP_20), .B0(ready_o), .B1(
        data_i[26]), .Y(Reg_SN[21]) );
  AO22_X0P7M_A9TS U15 ( .A0(Counter_SP_0_), .A1(data_o[9]), .B0(ready_o), .B1(
        data_i[10]), .Y(Reg_SN[20]) );
  AO22_X0P7M_A9TS U16 ( .A0(Counter_SP_0_), .A1(Reg_SP_18), .B0(ready_o), .B1(
        data_i[25]), .Y(Reg_SN[19]) );
  AO22_X0P7M_A9TS U17 ( .A0(Counter_SP_0_), .A1(data_o[8]), .B0(ready_o), .B1(
        data_i[9]), .Y(Reg_SN[18]) );
  AO22_X0P7M_A9TS U18 ( .A0(Counter_SP_0_), .A1(Reg_SP_16), .B0(ready_o), .B1(
        data_i[24]), .Y(Reg_SN[17]) );
  AO22_X0P7M_A9TS U19 ( .A0(Counter_SP_0_), .A1(data_o[7]), .B0(ready_o), .B1(
        data_i[8]), .Y(Reg_SN[16]) );
  AO22_X0P7M_A9TS U20 ( .A0(Counter_SP_0_), .A1(Reg_SP_14), .B0(ready_o), .B1(
        data_i[23]), .Y(Reg_SN[15]) );
  AO22_X0P7M_A9TS U21 ( .A0(Counter_SP_0_), .A1(data_o[6]), .B0(ready_o), .B1(
        data_i[7]), .Y(Reg_SN[14]) );
  AO22_X0P7M_A9TS U22 ( .A0(Counter_SP_0_), .A1(Reg_SP_12), .B0(ready_o), .B1(
        data_i[22]), .Y(Reg_SN[13]) );
  AO22_X0P7M_A9TS U23 ( .A0(Counter_SP_0_), .A1(data_o[5]), .B0(ready_o), .B1(
        data_i[6]), .Y(Reg_SN[12]) );
  AO22_X0P7M_A9TS U24 ( .A0(Counter_SP_0_), .A1(Reg_SP_10), .B0(ready_o), .B1(
        data_i[21]), .Y(Reg_SN[11]) );
  AO22_X0P7M_A9TS U25 ( .A0(Counter_SP_0_), .A1(data_o[4]), .B0(ready_o), .B1(
        data_i[5]), .Y(Reg_SN[10]) );
  AO22_X0P7M_A9TS U26 ( .A0(Counter_SP_0_), .A1(Reg_SP_8), .B0(ready_o), .B1(
        data_i[20]), .Y(Reg_SN[9]) );
  AO22_X0P7M_A9TS U27 ( .A0(Counter_SP_0_), .A1(data_o[3]), .B0(ready_o), .B1(
        data_i[4]), .Y(Reg_SN[8]) );
  AO22_X0P7M_A9TS U28 ( .A0(Counter_SP_0_), .A1(Reg_SP_6), .B0(ready_o), .B1(
        data_i[19]), .Y(Reg_SN[7]) );
  AO22_X0P7M_A9TS U29 ( .A0(Counter_SP_0_), .A1(data_o[2]), .B0(ready_o), .B1(
        data_i[3]), .Y(Reg_SN[6]) );
  AO22_X0P7M_A9TS U30 ( .A0(Counter_SP_0_), .A1(Reg_SP_4), .B0(ready_o), .B1(
        data_i[18]), .Y(Reg_SN[5]) );
  AO22_X0P7M_A9TS U31 ( .A0(Counter_SP_0_), .A1(data_o[1]), .B0(ready_o), .B1(
        data_i[2]), .Y(Reg_SN[4]) );
  AO22_X0P7M_A9TS U32 ( .A0(Counter_SP_0_), .A1(Reg_SP_2), .B0(ready_o), .B1(
        data_i[17]), .Y(Reg_SN[3]) );
  AO22_X0P7M_A9TS U33 ( .A0(Counter_SP_0_), .A1(data_o[0]), .B0(ready_o), .B1(
        data_i[1]), .Y(Reg_SN[2]) );
  AO22_X0P7M_A9TS U34 ( .A0(Counter_SP_0_), .A1(Reg_SP_0), .B0(ready_o), .B1(
        data_i[16]), .Y(Reg_SN[1]) );
  AND2_X0P7M_A9TS U35 ( .A(data_i[0]), .B(ready_o), .Y(Reg_SN[0]) );
endmodule
...
module Serializer_00000002_00000004_00000003 ( io_clk, io_rst, io_dataIn, 
  ...
  AO22_X1P4M_A9TS U4 ( .A0(io_clk[1]), .A1(n5), .B0(n1), .B1(n3), .Y(
        io_dataOut) );
  DFFRPQN_X3M_A9TS reg_SP_reg_1_ ( .D(io_dataIn[1]), .CK(io_clk[1]), .R(io_rst), .QN(n4) );
  DFFRPQN_X3M_A9TS reg_SP_reg_0_ ( .D(io_dataIn[0]), .CK(io_clk[1]), .R(io_rst), .QN(n2) );
  INV_X0P8M_A9TS U3 ( .A(io_clk[1]), .Y(n1) );
  INV_X0P8M_A9TS U5 ( .A(n2), .Y(n3) );
  INV_X1P7M_A9TS U6 ( .A(n4), .Y(n5) );
endmodule
...
module Serializer_00000004_00000004_00000002 ( io_clk, io_rst, io_dataIn, 
  ...
  DFFRPQ_X0P5M_A9TS reg_SP_reg_0_ ( .D(io_dataIn[0]), .CK(io_clk[2]), .R(
        io_rst), .Q(reg_SP[0]) );
  INV_X1M_A9TS U3 ( .A(io_clk[2]), .Y(n1) );
  AO22_X1M_A9TS U4 ( .A0(io_clk[2]), .A1(reg_SP[3]), .B0(n1), .B1(reg_SP[1]), 
        .Y(dataOut[1]) );
  AO22_X1M_A9TS U5 ( .A0(io_clk[2]), .A1(reg_SP[2]), .B0(n1), .B1(reg_SP[0]), 
        .Y(dataOut[0]) );
endmodule
...
module Serializer_00000008_00000004_00000001 ( io_clk, io_rst, io_dataIn, 
  ...
  AO22_X0P7M_A9TS U7 ( .A0(io_clk[3]), .A1(reg_SP[4]), .B0(n1), .B1(reg_SP[0]), 
        .Y(dataOut[0]) );
  INV_X1M_A9TS U3 ( .A(io_clk[3]), .Y(n1) );
endmodule
...
module Serializer_00000010_00000004_0 ( io_clk, io_rst, io_dataIn, io_dataOut
  ...
  INV_X1M_A9TS U3 ( .A(io_clk[4]), .Y(n1) );
endmodule
...
module toplevel_mixed_serializer ( data_i, data_o, ready_o, clk_i, reset_ni );
  ...
  DFFRPQ_X3M_A9TS dataOut_SP_reg ( .D(dataOut_SN), .CK(clk_i), .R(reset_ni), 
        .Q(data_o) );
endmodule
