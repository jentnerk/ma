...
module mux_00000010 ( mux_i, mux_control_S, mux_o );
  ...
  INV_X1M_A9TS U1 ( .A(mux_control_S), .Y(n1) );
  AO22_X1M_A9TS U9 ( .A0(mux_control_S), .A1(mux_i[8]), .B0(n1), .B1(mux_i[0]), 
        .Y(mux_o[0]) );
  AO22_X1M_A9TS U8 ( .A0(mux_control_S), .A1(mux_i[9]), .B0(n1), .B1(mux_i[1]), 
        .Y(mux_o[1]) );
  AO22_X1M_A9TS U5 ( .A0(mux_control_S), .A1(mux_i[12]), .B0(n1), .B1(mux_i[4]), .Y(mux_o[4]) );
  AO22_X1M_A9TS U2 ( .A0(mux_control_S), .A1(mux_i[15]), .B0(n1), .B1(mux_i[7]), .Y(mux_o[7]) );
  AO22_X1M_A9TS U6 ( .A0(mux_control_S), .A1(mux_i[11]), .B0(n1), .B1(mux_i[3]), .Y(mux_o[3]) );
  AO22_X1M_A9TS U3 ( .A0(mux_control_S), .A1(mux_i[14]), .B0(n1), .B1(mux_i[6]), .Y(mux_o[6]) );
  AO22_X1M_A9TS U7 ( .A0(mux_control_S), .A1(mux_i[10]), .B0(n1), .B1(mux_i[2]), .Y(mux_o[2]) );
  AO22_X1M_A9TS U4 ( .A0(mux_control_S), .A1(mux_i[13]), .B0(n1), .B1(mux_i[5]), .Y(mux_o[5]) );
endmodule
...
module mux_00000008 ( mux_i, mux_control_S, mux_o );
  ...
  INV_X1M_A9TS U1 ( .A(mux_control_S), .Y(n1) );
  AO22_X1M_A9TS U4 ( .A0(mux_control_S), .A1(mux_i[5]), .B0(n1), .B1(mux_i[1]), 
        .Y(mux_o[1]) );
  AO22_X1M_A9TS U2 ( .A0(mux_control_S), .A1(mux_i[7]), .B0(n1), .B1(mux_i[3]), 
        .Y(mux_o[3]) );
  AO22_X1M_A9TS U5 ( .A0(mux_control_S), .A1(mux_i[4]), .B0(n1), .B1(mux_i[0]), 
        .Y(mux_o[0]) );
  AO22_X1M_A9TS U3 ( .A0(mux_control_S), .A1(mux_i[6]), .B0(n1), .B1(mux_i[2]), 
        .Y(mux_o[2]) );
endmodule
...
module mux_00000004 ( mux_i, mux_control_S, mux_o );
  ...
  AO22_X1P4M_A9TS U2 ( .A0(mux_control_S), .A1(mux_i[3]), .B0(n1), .B1(
        mux_i[1]), .Y(mux_o[1]) );
  AO22_X1P4M_A9TS U3 ( .A0(mux_control_S), .A1(mux_i[2]), .B0(n1), .B1(
        mux_i[0]), .Y(mux_o[0]) );
  INV_X1M_A9TS U1 ( .A(mux_control_S), .Y(n1) );
endmodule
...
module Serializer_00000002_00000005_00000004 ( io_clk, io_rst, io_dataIn, 
  ...
  DFFRPQN_X3M_A9TS reg_SP_reg_1_ ( .D(io_dataIn[1]), .CK(io_clk[1]), .R(io_rst), .QN(n1) );
  INV_X0P8M_A9TS U3 ( .A(n2), .Y(reg_SP[0]) );
  INV_X1P7M_A9TS U4 ( .A(n1), .Y(reg_SP[1]) );
endmodule
...
module Serializer_00000004_00000005_00000003 ( io_clk, io_rst, io_dataIn, 
  ...
  mux_00000004 mux ( .mux_i({n8, n6, n4, n2}), .mux_control_S(io_clk[2]), 
        .mux_o(dataOut) );
  Serializer_00000002_00000005_00000004 recursive_serializer ( .io_clk(
        io_clk[1]), .io_rst(io_rst), .io_dataIn(dataOut), .io_dataOut(
        io_dataOut) );
  DFFRPQN_X3M_A9TS reg_SP_reg_3_ ( .D(io_dataIn[3]), .CK(io_clk[2]), .R(io_rst), .QN(n7) );
  DFFRPQN_X3M_A9TS reg_SP_reg_2_ ( .D(io_dataIn[2]), .CK(io_clk[2]), .R(io_rst), .QN(n5) );
  DFFRPQN_X3M_A9TS reg_SP_reg_1_ ( .D(io_dataIn[1]), .CK(io_clk[2]), .R(io_rst), .QN(n3) );
  DFFRPQN_X3M_A9TS reg_SP_reg_0_ ( .D(io_dataIn[0]), .CK(io_clk[2]), .R(io_rst), .QN(n1) );
  INV_X0P8M_A9TS U3 ( .A(n1), .Y(n2) );
  INV_X1M_A9TS U4 ( .A(n3), .Y(n4) );
  INV_X1P7M_A9TS U5 ( .A(n5), .Y(n6) );
  INV_X1P7M_A9TS U6 ( .A(n7), .Y(n8) );
endmodule
...
module Clock_divider_2 ( clk_div_o, clk_fast_i, reset );
  ...
  DFFRPQ_X0P5M_A9TS clk_div_reg ( .D(n2), .CK(clk_fast_i), .R(reset), .Q(
        clk_div_o) );
  INV_X1M_A9TS U3 ( .A(clk_div_o), .Y(n2) );
endmodule
