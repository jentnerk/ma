...
# Created by write_sdc on Sat Jan 19 13:21:14 2019
...
create_clock [get_ports clk_i]  -period 0.05  -waveform {0 0.025}
...
create_generated_clock [get_pins clk__5__clock_divider/clk_div_reg/Q]  -name CLK_DIV_32  -source [get_ports clk_i]  -divide_by 32
