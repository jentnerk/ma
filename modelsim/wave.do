...
add wave -noupdate -expand -group dut -color Red /serializer_tb/dut/clk
add wave -noupdate -expand -group dut -color Red /serializer_tb/dut/clkB
...
add wave -noupdate -expand -group serializer /serializer_tb/dut/Serializer/area_clkB_buf0
add wave -noupdate -expand -group serializer /serializer_tb/dut/Serializer/area_clkB_buf1
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 3} {260 ns} 0}
